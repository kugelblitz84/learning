...
typedef struct process{
 ...
 int priority;
 int cpu1, io, cpu2;
 int completion_time; // Initialization moved
 bool qued; // Initialization moved
} process;
...
void pop_q(){process_q[0]->qued = false;
...
int main(){
 ...
 scanf("%d %d %d", &process_no[i].cpu1, &process_no[i].io,
&process_no[i].cpu2);
